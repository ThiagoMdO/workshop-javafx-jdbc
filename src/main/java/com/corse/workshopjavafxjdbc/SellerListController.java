...
import com.corse.workshopjavafxjdbc.db.DbIntegrityException;
...
public class SellerListController implements Initializable, DataChangeListener {
    ...
    public void updateTableView() {
        if (SellerService == null) throw new IllegalStateException("Service was null");
    ...
    private void removeEntity(Seller obj){
        ...
        if(result.get() == ButtonType.OK){
            if(SellerService == null) throw new IllegalStateException("SellerService was null");
            try {
